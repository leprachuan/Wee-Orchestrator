...
def dispatch_wee_dev(item: dict) -> str:
    ...
    prompt = (
        ...
        f"     Do NOT omit runtime or model — the API defaults to 'copilot' if left out. "
        f"Use the exact runtime and model above. Do NOT use 'copilot' unless "
        f"{qa_cfg['runtime']!r} is explicitly blocked in /opt/RUNTIME_STATE.md.\n"
