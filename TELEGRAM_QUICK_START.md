...
**Bot doesn't respond?**
- Verify token: `python3 -c "import requests; import json; r = requests.get('https://api.telegram.org/bot[REDACTED-TELEGRAM-TOKEN]/getMe'); print(json.dumps(r.json(), indent=2))"`
