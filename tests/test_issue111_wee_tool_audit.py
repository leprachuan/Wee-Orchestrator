...
class TestIssue111ToolAudit(unittest.TestCase):
    ...
    def test_build_agent_context_prompt_correct_arg_order(self, mock_openai_cls):
        """Issue #111: build_agent_context_prompt must be called with (agent, prompt, session_id, ...)  # noqa: E501

        The old buggy call was build_agent_context_prompt(prompt, agent, channel, session_id)  # noqa: E501
