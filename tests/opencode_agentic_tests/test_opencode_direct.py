    ...
    def run_opencode_api_test(self, test_name, prompt, timeout=60):
        ...
        try:
            ...
            cmd = [
                ...
                "-H", "X-User-Identity: wee-dev-test",
...
After processing all items, confirm you remember ALL five details."""
        ...
        success, output = self.run_opencode_api_test("context_multi_turn", prompt, timeout=45)
        
        required = ["machine learning", "deep learning", "nlp", "$50,000", "3", "6 months"]
    ...
    def test_tool_calling(self):
        ...
        tests = [
            ...
            ("code_gen", "Write Python to: 1) create list [1..100], 2) filter for primes, 3) sum them."),
            ("logic", "If x=7, is it prime? If y=12, what's gcd(y,18)? Show both calculations."),
        ]
...
Show all three steps and verify step 3 uses info from step 1."""
        ...
        success, output = self.run_opencode_api_test("flow_multi_step", prompt, timeout=45)
    ...
    def test_edge_cases(self):
        ...
        tests = [
            ("long", "Discuss LLM context windows. " * 40 + " Summarize in 2 sentences."),
            ("rapid", "Compute: factorial(5), fibonacci(8), prime_check(17), gcd(48,18), lcm(12,15)"),
            ("error_fix", "First, try: print(1/0). Then fix it to: result = 1/2; print(result)"),
        ]
