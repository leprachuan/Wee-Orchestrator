...
@pytest.mark.skip(
    reason="Targets wee_runtime._call_agent_handler, part of the legacy tool "
    "path #443 removed when the Wee runtime moved to the Copilot SDK. dev "
    "routes call_agent through agent_manager._wee_call_agent instead, which "
    "the sibling tests in this file cover. Re-implement here only if the "
    "wee_runtime dispatch path returns."
)
