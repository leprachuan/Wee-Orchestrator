...
class TestIssue105OllamaPort(unittest.TestCase):
    ...
    def test_agent_manager_presets_use_correct_port(self):
        ...
        self.assertIn("192.168.1.101:11434", source,
                       "run_wee_native should use port 11434")
        self.assertNotIn("192.168.1.101:11436", source,
    ...
    def test_agent_manager_fallback_uses_correct_port(self):
        ...
        assert source.count("11434") >= 2, "Should have at least 2 references to port 11434"
    ...
    def test_wee_runtime_presets_use_correct_port(self):
        ...
        self.assertIn("11434", ollama_base,
                       "wee_runtime.py ollama preset should use port 11434")
        self.assertNotIn("11436", ollama_base,
                          "wee_runtime.py should NOT use old port 11436")
...
class TestIssue105ModelResolution(unittest.TestCase):
    ...
    def test_model_resolution_prefix_stripped(self):
        """Model resolution: 'gemma4:e4b' matches 'ollama/gemma4:e4b' via prefix strip."""
        from agent_manager import SessionManager
        mgr = SessionManager()
    ...
    def test_model_resolution_shortest_match(self):
        ...
        from agent_manager import SessionManager
        mgr = SessionManager()
        # "gemma4:e2b" should match "ollama/gemma4:e2b" not "ollama/gemma4:e2b-nothinker"
        result = mgr.get_model_from_name("gemma4:e2b", "wee")
        self.assertEqual(result, "ollama/gemma4:e2b",
                         "Should prefer shortest match")
...
class TestIssue105TimeoutConfig(unittest.TestCase):
    ...
    def test_run_wee_native_uses_httpx_timeout(self):
        ...
        self.assertIn("connect=15.0", source,
                       "Should set 15s connect timeout")
...
class TestIssue105NoPortRegression(unittest.TestCase):
    ...
    def test_no_11436_in_agent_manager(self):
        ...
        self.assertNotIn("192.168.1.101:11436", content,
    ...
    def test_no_11436_in_wee_runtime(self):
        ...
        self.assertNotIn("11436", content,
                          "wee_runtime.py should have no references to port 11436")
