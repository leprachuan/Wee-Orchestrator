...
from tui.theme import get_agent_color, get_status_color, AGENT_COLORS, STATUS_COLORS
...
def test_agent_colors_mapping_complete():
    ...
    expected_agents = [
        "orchestrator", "wee-dev", "wee-qa", "wee-doc",
        "email-triage", "family-knowledge", "research", 
        "devops", "smarthome"
    ]
